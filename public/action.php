...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['company'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;">Company:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['company'] . '</b></td></tr>';
    }
